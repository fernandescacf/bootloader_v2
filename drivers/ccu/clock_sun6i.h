...
struct sunxi_ccm_reg {
	...
	uint32_t sata_pll_cfg;	/* 0x34 SATA pll control (R40 only) */
	uint32_t pll8_cfg;		/* 0x38 pll8 control */
	uint32_t reserved7;
	uint32_t mipi_pll_cfg;	/* 0x40 MIPI pll control */
	uint32_t pll9_cfg;		/* 0x44 pll9 control */
	uint32_t pll10_cfg;		/* 0x48 pll10 control */
	uint32_t pll11_cfg;		/* 0x4c pll11 (ddr1) control (A33 only) */
	uint32_t cpu_axi_cfg;	/* 0x50 CPU/AXI divide ratio */
	uint32_t ahb1_apb1_div;	/* 0x54 AHB1/APB1 divide ratio */
	uint32_t apb2_div;		/* 0x58 APB2 divide ratio */
	...
	uint32_t apb1_gate;		/* 0x68 apb1 module clock gating */
	uint32_t apb2_gate;		/* 0x6c apb2 module clock gating */
	uint32_t bus_gate4;          /* 0x70 gate 4 module clock gating */
	uint8_t res3[0xc];
	uint32_t nand0_clk_cfg;	/* 0x80 nand0 clock control */
	uint32_t nand1_clk_cfg;	/* 0x84 nand1 clock control */
	...
	uint32_t ss_clk_cfg;		/* 0x9c security system clock control */
	uint32_t spi0_clk_cfg;	/* 0xa0 spi0 clock control */
	uint32_t spi1_clk_cfg;	/* 0xa4 spi1 clock control */
	uint32_t spi2_clk_cfg;	/* 0xa8 spi2 clock control */
	uint32_t spi3_clk_cfg;	/* 0xac spi3 clock control */
	uint32_t i2s0_clk_cfg;	/* 0xb0 I2S0 clock control*/
	uint32_t i2s1_clk_cfg;	/* 0xb4 I2S1 clock control */
	uint32_t reserved10[2];
	uint32_t spdif_clk_cfg;	/* 0xc0 SPDIF clock control */
	uint32_t reserved11;
	uint32_t sata_clk_cfg;	/* 0xc8 SATA clock control (R40 only) */
	uint32_t usb_clk_cfg;	/* 0xcc USB clock control */
	uint32_t gmac_clk_cfg;	/* 0xd0 GMAC clock control */
	uint32_t reserved12[7];
	uint32_t mdfs_clk_cfg;	/* 0xf0 MDFS clock control */
	uint32_t dram_clk_cfg;	/* 0xf4 DRAM configuration clock control */
	uint32_t dram_pll_cfg;	/* 0xf8 PLL_DDR cfg register, A33 only */
	uint32_t mbus_reset;		/* 0xfc MBUS reset control, A33 only */
	uint32_t dram_clk_gate;	/* 0x100 DRAM module gating */
#ifdef CONFIG_SUNXI_DE2
	uint32_t de_clk_cfg;		/* 0x104 DE module clock */
#else
	uint32_t be0_clk_cfg;	/* 0x104 BE0 module clock */
#endif
	uint32_t be1_clk_cfg;	/* 0x108 BE1 module clock */
	uint32_t fe0_clk_cfg;	/* 0x10c FE0 module clock */
	uint32_t fe1_clk_cfg;	/* 0x110 FE1 module clock */
	uint32_t mp_clk_cfg;		/* 0x114 MP module clock */
#ifdef CONFIG_SUNXI_DE2
	uint32_t lcd0_clk_cfg;	/* 0x118 LCD0 module clock */
	uint32_t lcd1_clk_cfg;	/* 0x11c LCD1 module clock */
#else
	uint32_t lcd0_ch0_clk_cfg;	/* 0x118 LCD0 CH0 module clock */
	uint32_t lcd1_ch0_clk_cfg;	/* 0x11c LCD1 CH0 module clock */
#endif
	uint32_t tve_clk_cfg;	/* 0x120 H3/H5 TVE module clock */
	uint32_t reserved14[2];
	uint32_t lcd0_ch1_clk_cfg;	/* 0x12c LCD0 CH1 module clock */
	uint32_t lcd1_ch1_clk_cfg;	/* 0x130 LCD1 CH1 module clock */
	uint32_t csi0_clk_cfg;	/* 0x134 CSI0 module clock */
	uint32_t csi1_clk_cfg;	/* 0x138 CSI1 module clock */
	uint32_t ve_clk_cfg;		/* 0x13c VE module clock */
	uint32_t adda_clk_cfg;	/* 0x140 ADDA module clock */
	uint32_t avs_clk_cfg;	/* 0x144 AVS module clock */
	uint32_t dmic_clk_cfg;	/* 0x148 Digital Mic module clock*/
	uint32_t reserved15;
	uint32_t hdmi_clk_cfg;	/* 0x150 HDMI module clock */
#ifdef CONFIG_SUNXI_DE2
	uint32_t hdmi_slow_clk_cfg;	/* 0x154 HDMI slow module clock */
#else
	uint32_t ps_clk_cfg;		/* 0x154 PS module clock */
#endif
	uint32_t mtc_clk_cfg;	/* 0x158 MTC module clock */
	uint32_t mbus0_clk_cfg;	/* 0x15c MBUS0 module clock */
	uint32_t mbus1_clk_cfg;	/* 0x160 MBUS1 module clock */
	uint32_t reserved16;
	uint32_t mipi_dsi_clk_cfg;	/* 0x168 MIPI DSI clock control */
	uint32_t mipi_csi_clk_cfg;	/* 0x16c MIPI CSI clock control */
	uint32_t reserved17[4];
	uint32_t iep_drc0_clk_cfg;	/* 0x180 IEP DRC0 module clock */
	uint32_t iep_drc1_clk_cfg;	/* 0x184 IEP DRC1 module clock */
	uint32_t iep_deu0_clk_cfg;	/* 0x188 IEP DEU0 module clock */
	uint32_t iep_deu1_clk_cfg;	/* 0x18c IEP DEU1 module clock */
	uint32_t reserved18[4];
	uint32_t gpu_core_clk_cfg;	/* 0x1a0 GPU core clock config */
	uint32_t gpu_mem_clk_cfg;	/* 0x1a4 GPU memory clock config */
	uint32_t gpu_hyd_clk_cfg;	/* 0x1a0 GPU HYD clock config */
	uint32_t reserved19[21];
	uint32_t pll_lock;		/* 0x200 PLL Lock Time */
	uint32_t pll1_lock;		/* 0x204 PLL1 Lock Time */
	uint32_t reserved20[6];
	uint32_t pll1_bias_cfg;	/* 0x220 PLL1 Bias config */
	uint32_t pll2_bias_cfg;	/* 0x224 PLL2 Bias config */
	uint32_t pll3_bias_cfg;	/* 0x228 PLL3 Bias config */
	uint32_t pll4_bias_cfg;	/* 0x22c PLL4 Bias config */
	uint32_t pll5_bias_cfg;	/* 0x230 PLL5 Bias config */
	uint32_t pll6_bias_cfg;	/* 0x234 PLL6 Bias config */
	uint32_t pll7_bias_cfg;	/* 0x238 PLL7 Bias config */
	uint32_t pll8_bias_cfg;	/* 0x23c PLL8 Bias config */
	uint32_t mipi_bias_cfg;	/* 0x240 MIPI Bias config */
	uint32_t pll9_bias_cfg;	/* 0x244 PLL9 Bias config */
	uint32_t pll10_bias_cfg;	/* 0x248 PLL10 Bias config */
	uint32_t reserved21[5];
	uint32_t pll5_tuning_cfg;	/* 0x260 PLL5 Tuning config */
	uint32_t reserved21_5[7];
	uint32_t pll1_pattern_cfg;	/* 0x280 PLL1 Pattern config */
	uint32_t pll2_pattern_cfg;	/* 0x284 PLL2 Pattern config */
	uint32_t pll3_pattern_cfg;	/* 0x288 PLL3 Pattern config */
	uint32_t pll4_pattern_cfg;	/* 0x28c PLL4 Pattern config */
	uint32_t pll5_pattern_cfg;	/* 0x290 PLL5 Pattern config */
	uint32_t pll6_pattern_cfg;	/* 0x294 PLL6 Pattern config */
	uint32_t pll7_pattern_cfg;	/* 0x298 PLL7 Pattern config */
	uint32_t pll8_pattern_cfg;	/* 0x29c PLL8 Pattern config */
	uint32_t mipi_pattern_cfg;	/* 0x2a0 MIPI Pattern config */
	uint32_t pll9_pattern_cfg;	/* 0x2a4 PLL9 Pattern config */
	uint32_t pll10_pattern_cfg;	/* 0x2a8 PLL10 Pattern config */
	uint32_t pll11_pattern_cfg0; /* 0x2ac PLL11 Pattern config0, A33 only */
	uint32_t pll11_pattern_cfg1; /* 0x2b0 PLL11 Pattern config0, A33 only */
	uint32_t reserved22[3];
	uint32_t ahb_reset0_cfg;	/* 0x2c0 AHB1 Reset 0 config */
	uint32_t ahb_reset1_cfg;	/* 0x2c4 AHB1 Reset 1 config */
	uint32_t ahb_reset2_cfg;	/* 0x2c8 AHB1 Reset 2 config */
	uint32_t reserved23;
	uint32_t apb1_reset_cfg;	/* 0x2d0 APB1 Reset config */
	uint32_t reserved24;
	uint32_t apb2_reset_cfg;	/* 0x2d8 APB2 Reset config */
	uint32_t reserved25[5];
	uint32_t ccu_sec_switch;	/* 0x2f0 CCU Security Switch, H3 only */
